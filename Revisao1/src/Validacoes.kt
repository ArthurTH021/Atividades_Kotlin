...
//      Explicação da Regex:
//      - `^\d{3}\.\d{3}\.\d{3}-\d{2}$`: Aceita o formato com pontos e traço (ex: 123.456.789-01).
//      - `|^`: Ou pipe (OU)
//      - `\d{11}$`: Aceita exatamente 11 dígitos seguidos apenas por números (ex: 12345678901).
...
//      Substitui vírgula por ponto para evitar erros de formatação numérica do usuário brasileiro.
//
